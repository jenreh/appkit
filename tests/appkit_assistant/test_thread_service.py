...
from appkit_assistant.backend.schemas import Message, MessageType, ThreadModel, ThreadStatus
...
class TestThreadService:
    ...
    def test_create_new_thread_generates_uuid(self) -> None:
        ...
        with patch.object(service.model_manager, "get_all_models", return_value=[]):
            with patch.object(service.model_manager, "get_default_model", return_value="gpt-4"):
    ...
    def test_create_new_thread_uses_current_model(self) -> None:
        ...
        with patch.object(service.model_manager, "get_all_models", return_value=[mock_model]):
    ...
    def test_create_new_thread_respects_role_requirements(self) -> None:
        ...
        with patch.object(
            service.model_manager, "get_all_models", return_value=[admin_model, user_model]
        ):
    ...
    def test_create_new_thread_allows_role_access(self) -> None:
        ...
        with patch.object(service.model_manager, "get_all_models", return_value=[admin_model]):
    ...
    def test_create_new_thread_uses_default_when_invalid(self) -> None:
        ...
        with patch.object(
            ...
            with patch.object(service.model_manager, "get_default_model", return_value="gpt-3.5"):
                thread = service.create_new_thread("invalid-model")

        assert thread.ai_model == "gpt-3.5"

    def test_create_new_thread_uses_first_available_when_default_restricted(self) -> None:
        ...
        with patch.object(
            service.model_manager, "get_all_models", return_value=[restricted_default, accessible_model]
        ):
            with patch.object(service.model_manager, "get_default_model", return_value="gpt-4"):
    ...
    async def test_load_thread_returns_thread_model(self) -> None:
        ...
        db_thread = AssistantThread(
            ...
            ai_model="gpt-4",
            active=True,
            messages=[{"id": "msg-1", "text": "Hello", "type": "human", "done": True, "attachments": [], "annotations": []}],
            mcp_server_ids=[1, 2],
