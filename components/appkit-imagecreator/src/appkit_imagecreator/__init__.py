"""AppKit Image Creator package.

Provides image generation functionality with multiple AI backends
and a modern gallery UI.

Note: Components must be imported directly from their modules after
