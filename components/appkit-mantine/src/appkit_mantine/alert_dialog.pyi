...
class AlertDialogFooter(AlertDialogBase):
    ...
    def create(
        cls,
        *children,
        cancel_label: Var[str] | str | None = None,
        action_label: Var[str] | str | None = None,
        action_loading: Var[bool] | bool | None = None,
        cancel_props: Var[dict] | dict | None = None,
        action_props: Var[dict] | dict | None = None,
        style: Sequence[Mapping[str, Any]]
        | Mapping[str, Any]
        | Var[Mapping[str, Any]]
        | Breakpoints
