...
class Text(MantineLayoutComponentBase):
    ...
    def create(
        ...
        *children,
        ...
        | str
        | None = None,
        variant: Literal["gradient", "text"]
        | Var[Literal["gradient", "text"]]
        | None = None,
        gradient: Var[dict] | dict | None = None,
        truncate: Literal["end", "start"]
        | Var[Literal["end", "start"] | bool]
        | bool
        | None = None,
...
class List(MantineLayoutComponentBase):
    ...
    def create(
        cls,
        *children,
        type: Literal["ordered", "unordered"]
        | Var[Literal["ordered", "unordered"]]
        | None = None,
        size: Literal["lg", "md", "sm", "xl", "xs"]
        | Var[Literal["lg", "md", "sm", "xl", "xs"] | int | str]
        | int
        | str
        | None = None,
        spacing: Literal["lg", "md", "sm", "xl", "xs"]
        | Var[Literal["lg", "md", "sm", "xl", "xs"] | int | str]
        | int
        | str
        | None = None,
        center: Var[bool] | bool | None = None,
        icon: Var[any] | any | None = None,
        list_style_type: Var[str] | str | None = None,
        with_padding: Var[bool] | bool | None = None,
        w: Literal["lg", "md", "sm", "xl", "xs"]
        | Var[Literal["lg", "md", "sm", "xl", "xs"] | int | str]
        | int
        | str
...
class Highlight(MantineLayoutComponentBase):
    ...
    def create(
        cls,
        *children,
        highlight: Var[list[str] | str] | list[str] | str | None = None,
        color: Var[str] | str | None = None,
        gradient: Var[dict] | dict | None = None,
        size: Literal["lg", "md", "sm", "xl", "xs"]
        | Var[Literal["lg", "md", "sm", "xl", "xs"] | int | str]
        ...
        | None = None,
        line_clamp: Var[int] | int | None = None,
        case_insensitive: Var[bool] | bool | None = None,
        accent_insensitive: Var[bool] | bool | None = None,
        whole_word: Var[bool] | bool | None = None,
        highlight_styles: Var[dict] | dict | None = None,
        w: Literal["lg", "md", "sm", "xl", "xs"]
        | Var[Literal["lg", "md", "sm", "xl", "xs"] | int | str]
        | int
        | str
