...
class Splitter(MantineLayoutComponentBase):
    ...
    def create(
        ...
        *children,
        ...
        | None = None,
        sizes: Var[list[Any]] | list[Any] | None = None,
        line_size: Var[int | str] | int | str | None = None,
        with_handle: Var[bool] | bool | None = None,
        handle_color: Var[str] | str | None = None,
        handle_icon: Any | Var[Any] | None = None,
        redistribute: Literal["equal", "nearest"]
        | Var[Literal["equal", "nearest"]]
        | None = None,
        reset_on_double_click: Var[bool] | bool | None = None,
        ...
        on_size_change: EventType[Any] | None = None,
...
class SplitterPane(MantineLayoutComponentBase):
    ...
    def create(
        cls,
        *children,
        default_size: Var[int | str] | int | str | None = None,
        min: Var[int | str] | int | str | None = None,
        max: Var[int | str] | int | str | None = None,
