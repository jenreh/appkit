...
class RichTextEditor(NoSSRComponent):
    ...
    def create(
        cls,
        *children,
        content: Var[str | None] | str | None = None,
        editable: Var[bool | None] | bool | None = None,
        placeholder: Var[str | None] | str | None = None,
        variant: Literal["default", "subtle"]
        | Var[Literal["default", "subtle"]]
        | None = None,
        with_typography_styles: Var[bool | None] | bool | None = None,
        labels: Var[dict | None] | dict | None = None,
        control_groups: Var[list | None] | list | None = None,
        show_toolbar: Var[bool | None] | bool | None = None,
        sticky: Var[bool | None] | bool | None = None,
        sticky_offset: Var[int | str | None] | int | str | None = None,
        styles: Var[dict | None] | dict | None = None,
        class_names: Var[dict | None] | dict | None = None,
        ...
        on_update: EventType[Any] | None = None,
        **props,
    ) -> RichTextEditor:
