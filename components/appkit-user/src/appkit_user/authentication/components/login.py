                ...
                rx.cond(
                    ...
                    mn.stack(
                        ...
                        oauth_button(
                            ...
                            enabled=LoginState.enable_google_oauth,
                            variant="default",
                            size="md",
                            fw="300",
                        ...
                        oauth_button(
                            ...
                            enabled=LoginState.enable_apple_oauth,
                            variant="default",
                            size="md",
                            fw="300",
                            justify="space-between",
                        ...
                        oauth_button(
                            ...
                            enabled=LoginState.enable_azure_oauth,
                            variant="default",
                            size="md",
                            fw="300",
                            justify="space-between",
                        ...
                        oauth_button(
                            ...
                            enabled=LoginState.enable_github_oauth,
                            variant="default",
                            size="md",
                            fw="300",
                            justify="space-between",
