...
def navbar_items() -> rx.Component:
    return mn.stack(
        ...
        mn.stack(
            ...
            sidebar_sub_item(label="Data List", url="/data-list"),
            sidebar_sub_item(label="Empty State", url="/empty-state"),
            sidebar_sub_item(label="Feedback", url="/feedback"),
            sidebar_sub_item(label="Layout", url="/layout"),
            sidebar_sub_item(label="Splitter", url="/splitter"),
            ...
            sidebar_sub_item(label="Typography", url="/typography"),
            gap="0",
            w="100%",
        ),
